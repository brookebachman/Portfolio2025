...
const Work = () => {
  const projects = [
    {
      ...
      description:
        "A robust RESTful API built with Golang and SQLite for multi-tenant cybersecurity monitoring. Features secure login event ingestion, suspicious activity detection, and strict tenant data isolation with configurable threat thresholds.",
      image:
      ...
      icon: Shield,
      link: "https://github.com/brookebachman/LoginFlow",
    },
    {
      title: "Tellus Solutions",
      subtitle: "Enterprise Web Platform",
      description:
        "A comprehensive enterprise web platform delivering scalable solutions for business operations. Built with modern web technologies to provide robust functionality, seamless user experience, and enterprise-grade performance across multiple business domains.",
      image:
    ...
    },
    {
      ...
      description:
        "A cutting-edge cybersecurity platform providing comprehensive security solutions for modern businesses. Features advanced threat detection, security monitoring, and integrated protection services designed to safeguard digital infrastructure and data.",
      image:
    ...
    },
    {
      ...
      description:
        "A modern, responsive data dashboard built with TypeScript (79%) showcasing clean architecture and strong type safety. Originally developed as a technical assessment, demonstrating rapid delivery of polished, production-ready interfaces.",
      image:
    ...
    },
    {
      ...
      description:
        "A stunning, interactive portfolio website built with React, TypeScript, and Tailwind CSS. Features advanced animations, morphing lava lamp effects, and responsive design showcasing modern web development capabilities and attention to visual detail.",
      image:
      ...
      icon: Palette,
      link: "https://github.com/brookebachman/Portfolio2025",
    },
  ];
  ...
  return (
    <section
      id="work"
      className="bg-gradient-to-br from-orange-900 via-red-900 to-pink-900 py-24 lg:py-32"
    >
